...
// Generated on Tue, 12 Oct 2021 12:44:42 GMT


import UIKit

public enum StyleDictionaryColor {
    public static let blablaBla = UIColor(red: 0.937, green: 0.365, blue: 0.659, alpha: 1)
    public static let blablaBlaAsas0 = UIColor(red: 0.937, green: 0.365, blue: 0.659, alpha: 1)
    public static let blablaBlaAsas1 = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.2)
